    ...
    for i in range(2, 100, 1):
        ...
        if getType != None :
            ...
            if getStatus != 'v' or getStatus == '불가능' :
                ...
                # 수량 및 무게 입력력
                driver.find_element_by_id('boxCount').send_keys(str(getQty))
                driver.find_element_by_id('weight').send_keys(str(sendWeight))
                driver.find_element_by_id('contents').send_keys('인형')
