...
options.add_argument("--window-size=1700,800")
        ...
        if getStatus != 'v' :
            ...
            for trCnt in range(1, (proRows + 1)):
                ...
                if int(maximumBox) == 1:  # 박스 수량 1개일때
                    ...
                    print (' 다중 박스 입력 시작')
                    # 서플라이에서 한개의 발주번호가져오기
                    lineBill = driver.find_element(By.XPATH, '/html[1]/body/div[1]/div[2]/div[2]/div[2]/div[4]/table/tbody/tr['+  str(trCnt)  +']/td[1]').text
                    lineSKU = driver.find_element(By.XPATH, '/html[1]/body/div[1]/div[2]/div[2]/div[2]/div[4]/table/tbody/tr['+  str(trCnt)  +']/td[2]').text
                    #가져온 발주번호를 드라이브에서 찾기
                        ...
                        if tempData3 == lineSKU :
                            ...
                            if getBoxData.find(',') > 0 :
                                ...
                                if currentBoxCnt > 1 :
                                    ...
                                    waitTime('s')
                                    driver.find_element_by_id('splitCount').send_keys(currentBoxCnt)
                                    driver.find_element_by_id('split').click()
                                    waitTime('s')
                                ...
                                for targetBox in range(1, currentBoxCnt+1 ):
                                    ...
                                    driver.find_element(By.XPATH,
                                        '/html[1]/body[1]/div[1]/div[2]/div[2]/div[2]/div[4]/table/tbody/tr[' + str(
                                            trCnt) + ']/td[8]/input[' + str(targetBox) + ']').clear()  # 기존수량 삭제

                                    driver.find_element(By.XPATH,
                                        '/html[1]/body[1]/div[1]/div[2]/div[2]/div[2]/div[4]/table/tbody/tr[' + str(
                                            trCnt) + ']/td[8]/input[' + str(targetBox) + ']').send_keys(str(dashSplit[1]))  # 수량입력
            ...
            for xCnt in range(1, maximumBox+1 ,1) :
                while 1 :
                    try :
                        driver.find_element(By.XPATH, '/html[1]/body/div[1]/div[2]/div[2]/div[2]/div[4]/table/tbody/tr[' + str(xCnt) + ']/td[2]/select').click()
                        driver.find_element(By.XPATH, '/html[1]/body/div[1]/div[2]/div[2]/div[2]/div[4]/table/tbody/tr[' + str(xCnt) + ']/td[2]/select/option['+ str(xCnt + 1) +']').click()
                        break
                    except : continue
                waitTime('s')
